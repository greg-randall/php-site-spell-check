...
include 'dict.php';
 ...
 // array called $dictionary. this file of words is from here: http://norvig.com/google-books-common-words.txt . read a little about the methodology of that list http://norvig.com/mayzner.html
...
foreach($lines as & $line) { //go through each line one at a time
   ...
   if (trim($line) == "</body>") { // find the end of the page and print the list of misspelled words, a form to change the page's url, and go to the live site
      ...
      echo "</p>\n";
      echo "<h3 style=\"color:black;\">Change URL:</h3>\n
            <form action=\"index.php\" method=\"get\">
<input type=\"text\" name=\"p\" value=\"$url\"><br />
<input type=\"submit\">
</form><br />\n
<h3 style=\"color:black;\"><a href=\"$url\">Go To Live Site</a></h3>


</div>\n</body>";
   }
   else
   if (substr($line, 0, 3) == "<a ") { //if a line contains a link rework it to always stay inside the spellchecker
